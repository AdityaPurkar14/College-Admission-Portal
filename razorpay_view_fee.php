...
<body>
    <script>
        var options = {
            ...
            "amount": "<?= $amount; ?>",  // Amount in paisa (₹ = 100 paise)
            "currency": "INR",  // Currency
            "name": "<?= $name; ?>",  // Name of the user
            "description": "Program Fees Payment",  // Description
            "order_id": "<?= $order_id; ?>",  // Order ID generated by Razorpay
            "handler": function (response) {
                var form = document.createElement('form');
                form.method = 'POST';
                form.action = "<?= base_url('feepayment/callback'); ?>";  // Your callback URL
